...
public abstract class Capability implements Runnable, MessageListener,
     ...
     *
     * @param tid a unique identifier for this task.
     * @param cid a unique identifier for this capability.
     ...
     *
     * @param message the input to this capability
     ...
     * @param outputVal  the output to send
     ...
     *
     * @param newStatus        the status of the capability
     * @param newStatusMessage the message associated with the status
     *                         <p>
     *                         Example:
     *                         <p>
     ...
     *
     * @param param the name of the input parameter
     ...
     *
     * @param param the name of the input parameter to retrieve
