...
import edu.cmu.gizmo.management.taskmanager.scripttask.*;
...
public class ScriptTaskStrategy extends TaskExecutionStrategy {
     ...
     *
     * @param cobot    the reference to the robot
     * @param taskId   the task identifier assigned by the Task Manager when the new
     ...
     *
     * @param capability the <code>Capability</code> to monitor.
     * @see Observable
     * @see TaskManager
     */
     ...
     * LOADED state.
     *
     * @param task the capability to load.
     * @see Capability
     */
