...
abstract class TaskExecutionStrategy extends Observable {
     ...
     * execute the task.
     *
     * @pre The concrete strategy has been instantiated
     * and is ready to execute
     * @post The concrete strategy is executing
     * @rationale The task should know how to execute itself. This call should
     ...
     * @pre The task is running
     * @post the task is paused
     * @rationale Every task should be able to pause itself meaning it should save the
     ...
     * @pre The task is currently paused
     * @post The task is resumed
     * @rationale Every task should be able to resume itself when paused meaning it should
     ...
     *
     * @pre The task is currently PAUSED, RUNNING, or READY
     * @post The task is terminated and status is set to CANCELED
     * @rationale Terminating a task is an operation common to all tasks
     * @example <pre>
     * exe.terminate();
     * </pre>
     */
