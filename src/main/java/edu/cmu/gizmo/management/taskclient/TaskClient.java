...
public class TaskClient extends Observable
     ...
     * @param input  the input as a set of key/values in a ConcurrentHashMap
     */
    ...
    private class ClientTaskMessageHandler implements TaskMessageHandler {
         ...
         *
         * @param message the capability complete message
         */
         ...
         *
         * @param message the CapabilityOutputMessage
         */
